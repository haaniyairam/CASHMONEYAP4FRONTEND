...
export default function Navbar(){
    ...
    return(
        ...
        <div className=" w-screen md:py-0 py-4 md:h-16 xl:h-24 bg-gradient-to-r from-[#940242] to-[#f15483] md:justify-between md:flex md:items-center">
            ...
            <a href="/" className="text-white mx-5 xl:mx-10 self-center font-bold font-Cinzel xl:text-6xl select-none">UniBarter</a>
            ...
            <div className={`md:my-0 z-15 md:z-auto mr-20 md:px-0 md:py-0 px-4 py-2 md:block ${hide ? "hidden" : ""}`}>
                ...
                <Link href="/login" className="text-white text-sm font-bold font-Cinz mr-6 xl:text-2xl"> Log In </Link>
                <Link href="/requests" className="text-white text-sm font-bold font-Cinz mr-6 xl:text-2xl"> Requests </Link>
                </div>
                </div>
        </div>
        </div>
